export function getMarkup() {
	return `
<!-- Day 043 -->
	<div class="day-043 frame" id="day-043">
		<span class="code-link">
			<a
				href="https://github.com/aniqatc/css-100/tree/main/entries/043"
				target="_blank"
				rel="noreferrer"
				>Day 043: Lightbulb</a
			>
	...
	<div class="center">
		<svg class="bulb" width="76px" height="94px">
		...
		<div class="glow"></div>
		<svg class="base" width="32px" height="33px">
